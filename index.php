            ...
            <div class="container">
                <div class="header-middle-left">
                    <div class="header-logo">
                        <a href="">
                            <img src="./assets/img/iconlogo (3).png" alt="" class="header-logo-img">
                        </a>
                    </div>
                </div>
    ...
    <nav class="header-bottom">
        <div align="center" class="container">
            <ul class="menu-list">
                ...
                <li class="menu-list-item" onclick="showCategory('Lớp 10')"><a href="javascript:;" class="menu-link">Lớp
                        10</a></li>
                <li class="menu-list-item" onclick="showCategory('Lớp 11')"><a href="javascript:;" class="menu-link">Lớp
                        11</a></li>
                <li class="menu-list-item" onclick="showCategory('Lớp 12')"><a href="javascript:;" class="menu-link">Lớp
                        12</a></li>
                <li class="menu-list-item" onclick="showCategory('Sách khác')"><a href="javascript:;"
                        class="menu-link">Sách khác</a></li>
            ...
            <div class="forms mdl-cnt">
                <div class="form-content sign-up">
                    ...
                    <form action="" class="signup-form">
                        ...
                        <div class="form-group">
                            <label for="email_confirmation" class="form-label">Nhập email</label>
                            <input id="email_confirmation" name="email_confirmation" placeholder="Nhập lại mật khẩu"
                                type="email" class="form-control">
                            <span class="form-message-email-confi form-message"></span>
                        </div>
                        <div class="form-group">
    ...
    <div class="container" id="gioithieu" style="display: none; overflow: hidden; scroll-behavior: auto;">
        <div class="introduction-container">
            ...
            <section class="support">
                ...
                <p>Chúng tôi luôn sẵn sàng lắng nghe ý kiến đóng góp của bạn. Nếu có bất kỳ câu hỏi hay cần hỗ trợ, xin
                    vui lòng liên hệ với chúng tôi qua email: <a
                        href="mailto:baonvt.23it@vku.udn.vn">baonvt.23it@vku.udn.vn</a> hoặc gọi điện thoại tới số: 0905
                    970 546.</p>
            </section>
            ...
            <div class="footer-top">
                <div class="footer-top-content">
                    <div class="footer-top-img">
                        <img src="./assets/img/iconlogos.png" alt="">
                    </div>
                        ...
                        <div class="contact">
                            <div class="contact-item">
                                ...
                                <div class="contact-content">
                                    <span>Huyện Quỳnh Phụ, Tỉnh Thái Bình</span>
                                </div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-item-icon">
                            ...
                            <div class="contact-item">
                                ...
                                <div class="contact-content conatct-item-email">
                                    <span>minhduc22327@gmail.com</span><br />
                                    <span>duclvm.23it@vku.udn.vn</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="copyright-content">
                <p>Bản quyền 2025 Book Shop. by Minh Đức.</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="checkout-col-content">
                        ...
                        <div class="content-group" id="tudenlay-group">
                            ...
                            <div class="delivery-time">
                                ...
                                <label for="chinhanh-1">Thành Phố Hà Nội</label>
                            </div>
                            <div class="delivery-time">
                                <input type="radio" name="chinhanh" id="chinhanh-2" class="radio">
                                <label for="chinhanh-2">Thành Phố Hải Phòng</label>
                            </div>
                        </div>
                        <div class="content-group">
