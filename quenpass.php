...
if (isset($_POST['btn1'])) {
    ...
    if (!$row) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'minhthuanvan2004@gmail.com'; // ví dụ: abc@gmail.com
            $mail->Password = 'nlup knaa ebif fegb'; // Mật khẩu ứng dụng tạo từ Google
            ...
            $mail->setFrom('minhthuanvan2004@gmail.com', 'Ban quản trị Website BOOK SHOP (VKU)');
