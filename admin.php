    ...
    <div class="container">
        <aside class="sidebar open">
            <div class="top-sidebar">
                <a href="#" class="channel-logo"><img src="./assets/img/iconlogo.jpg" alt="Channel Logo"></a>
            ...
            <div class="section product-all">
                <div class="admin-control">
                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            ...
                            <input id="form-search-product" type="text" class="form-search-input"
                                placeholder="Tìm kiếm sách giáo khoa..." oninput="showProduct()">
                        </form>
                    </div>
                    <div class="admin-control-right">
                        ...
                        <button class="btn-control-large" id="btn-add-product"><i class="fa-light fa-plus"></i> Thêm
                            sách mới</button>
                    </div>
                </div>
                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            ...
                            <input id="form-search-tk" type="text" class="form-search-input"
                                placeholder="Tìm kiếm sách giáo khoa..." oninput="thongKe()">
                        </form>
                    </div>
                    <div class="admin-control-right">
                        <form action="" class="fillter-date">
                        ...
                        <button class="btn-reset-order" onclick="thongKe(1)"><i
                                class="fa-regular fa-arrow-up-short-wide"></i></i></button>
            ...
            <div class="form-content sign-up">
                <form action="" class="signup-form">
                    <div class="form-group">
                        ...
                        <input id="fullname" name="fullname" type="text" placeholder="VD: Đỗ Nguyễn Thiên"
                            class="form-control">
